...
own |> 
  ...
  arrange(desc(n)) |> 
  kbl(col.names = c("Pick", "N", "Enteries"), caption = "Week 4 Picks") |> 
  kable_paper(full_width = F)
...
Now there is a roughly 20% chance we see a NE win, and a NYJ loss moving us onto next week with at most 3 other compeditors. Fingers crossed, and onto week 5! 
